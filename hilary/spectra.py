...
from hilary.utils_simulate import mutations2Spectrum,mutationsInFamily,mutations2Counter
...
class Spectra():
    ...
    def compute(self,
        ...
        self.small = self.small.sort_values(by='family_size', ascending=True, inplace=False, ignore_index=True)
        self.large = self.large.sort_values(by='family_size', ascending=True, inplace=False, ignore_index=True)
    ...
    def computeSmall(self, args, verbatim=False):
        ...
        return result[['family_size','mutation_spectrum']].astype({'family_size': int, 'mutation_spectrum': str})
    ...
    def computeLarge(self, args, verbatim=False):
        ...
        return result.astype({'family_size': int, 'configurations': str, 'number_of_mutations': str})
